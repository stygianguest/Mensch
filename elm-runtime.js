             ...
             };Elm.Set = function (elm)
          {
             ...
             };Elm.Dict = function (elm)
           {
                                        ...
                                        return function ()
                                               {
                                                 ...
                                                 _E.Case($moduleName,"between lines 158 and 179");
                                               }();
                                      });
                                       ...
                                       {case
                                        ...
                                        "RBNode" :
                                          return A3(foldl,
                                                    ...
                                                    t._4);}
                                       _E.Case($moduleName,"between lines 384 and 389");
                                     }();
                            });
                                       ...
                                       {case
                                        ...
                                        "RBNode" :
                                          return A3(foldr,
                                                    ...
                                                    t._3);}
                                       _E.Case($moduleName,"between lines 392 and 397");
                                     }();
                            });
             var keys = function (t)
                        {
                               ...
                               return function ()
                                      {
                                        ...
                                        _E.Case($moduleName,"between lines 146 and 155");
                                      }();
                             });
                                     ...
                                     {case
                                      ...
                                      "RBNode" :
                                        return A5(RBNode,
                                                  ...
                                                  A2(map,f,t._3),
                                                  A2(map,f,t._4));}
                                     _E.Case($moduleName,"between lines 376 and 381");
                                   }();
                          });
             var min = function (t)
                       {
                         return function ()
                                {
                                  ...
                                  {case
                                   ...
                                   "RBNode" :
                                     ...
                                     return min(t._3);}
                                  _E.Case($moduleName,"between lines 129 and 143");
                                }();
                       };
                                ...
                                return function ()
                                       {
                                         ...
                                         {case
                                          ...
                                          "Red" :
                                            return Black;}
                                         _E.Case($moduleName,"on line 210, column 16 to 57");
                                       }();
                              };
             ...
             var moveRedLeftIfNeeded = function (t)
                                       {
                                         return isRedLeft(t) || isRedLeftLeft(t) ? t : moveRedLeft(t);
                                       };
             ...
             var moveRedRight = function (t)
                                {
                                  return function ()
                                         {
                                           var t$ = color_flip(t);
                                           return isRedLeftLeft(t$) ? color_flip(rotateRight(t$)) : t$;
                                         }();
                                };
             var moveRedRightIfNeeded = function (t)
                                        {
                                          return isRedRight(t) || isRedRightLeft(t) ? t : moveRedRight(t);
                                        };
                                                    ...
                                                    return function ()
                                                           {
                                                             ...
                                                             {case
                                                              ...
                                                              "RBNode" :
                                                                return _N.cmp(k,
                                                                              t._1) < 0 ? delLT(t) : function ()
                                                                                                     {
                                                                                                       var u = isRedLeft(t) ? rotateRight(t) : t;
                                                                                                       return eq_and_noRightNode(u) ? RBEmpty : function ()
                                                                                                                                                {
                                                                                                                                                  var t$ = moveRedRightIfNeeded(t);
                                                                                                                                                  return eq(t$) ? delEQ(t$) : delGT(t$);
                                                                                                                                                }();
                                                                                                     }();}
                                                             _E.Case($moduleName,
                                                               ...
                                                               {case
                                                                ...
                                                                "RBNode" :
                                                                  return fixUp(A5(RBNode,
                                                                                  ...
                                                                                  _case255._4));}
                                                               _E.Case($moduleName,
                                                                       "between lines 346 and 349");
                                                             }();
                                                    };
                                        return A2(member,k,t) ? ensureBlackRoot(del(t)) : t;
                                      }();
                             });
